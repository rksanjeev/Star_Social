...
class GroupMember(models.Model):
    group = models.ForeignKey(Group, on_delete = models.SET_NULL, related_name='memberships')
    user = models.ForeignKey(User, on_delete = models.SET_NULL, related_name='user_groups')
